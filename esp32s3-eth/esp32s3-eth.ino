/**
 *  Interactive: NA
 *  File: esp32s3-eth.ino
 *  Description: establish basic Ethernet connectivity between ESP32-S3-ETH module <-> Macbook
 *
 *  Author: Isai Sanchez
 *  Date: 2-5-2026
 *  Hardware:
 *    - ESP32-S3-ETH Module from Waveshare (https://www.waveshare.com/wiki/ESP32-S3-ETH#Overview)
 *  Notes: 
 *    - SPI needs to be initialized with different pin numbering (see definitions below)
...
void setup() {
  ...
  Serial.println();
  Serial.println("==========================================");
  Serial.println("       ESP32-S3-ETH ETHERNET TEST        ");
  Serial.println("==========================================");
  Serial.println();
